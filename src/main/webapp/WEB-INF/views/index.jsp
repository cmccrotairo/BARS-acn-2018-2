...
<br><br>
	<form action="process.htm" method="POST" enctype="multipart/form-data">
...
<center>
		...
		<table align= "Center" style="font-family: Calibri, Garamond, Serif; ">
			<tr>
			<td colspan=125><img src="resources/Mentoring_Male_Female4.jpg" height=200 width=200></td>
				<td valign="center">
					<table align= "center">
						<tr><td>Request File :</td><td><input type="file" name="file" dir="ltr"/></td></tr>
						<tr><td></td><td align="right"><input type="submit" value="Process" /></td></tr>
					</table>
				</td>
	<!-- 			<td colspan=50><img src="resources/Computer_training2_jpg.jpg" height=200 width=150></td>
				<td colspan=50><img src="resources/10876_jpg.jpg" height=200 width=250></td>  -->
